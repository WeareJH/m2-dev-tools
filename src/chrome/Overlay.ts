...
export class Overlay {
    ...
    inspect(node, name) {
        ...
        var box = getNestedBoundingClientRect(node, (this.win as any));
...
// etc).
function getOwnerWindow(node): Window | null {
...
function getNestedBoundingClientRect(node, boundaryWindow: Window): DOMRect {
    var ownerIframe = getOwnerIframe(node);
    if (
        ownerIframe &&
        ownerIframe !== (boundaryWindow as any)
    ) {
